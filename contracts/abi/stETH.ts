...
export const stETHAbi: Abi = [
  ...
  },
  {
    constant: true,
    inputs: [],
    name: "BUFFER_RESERVE_MANAGER_ROLE",
  ...
  {
    constant: false,
    inputs: [{ name: "_newDepositsReserveTarget", type: "uint256" }],
    name: "setDepositsReserveTarget",
    outputs: [],
    payable: false,
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      { name: "_amount", type: "uint256" },
      { name: "_seedDepositsCount", type: "uint256" },
    ],
    name: "withdrawDepositableEther",
    outputs: [],
    payable: false,
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    constant: true,
    inputs: [],
    name: "getBalanceStats",
    outputs: [
      { name: "clValidatorsBalanceAtLastReport", type: "uint256" },
      { name: "clPendingBalanceAtLastReport", type: "uint256" },
      { name: "depositedSinceLastReport", type: "uint256" },
      { name: "depositedForCurrentReport", type: "uint256" },
    ],
    payable: false,
    stateMutability: "view",
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      { name: "_reportTimestamp", type: "uint256" },
      { name: "_clValidatorsBalance", type: "uint256" },
      { name: "_clPendingBalance", type: "uint256" },
    ],
  ...
  { anonymous: false, inputs: [], name: "StakingLimitRemoved", type: "event" },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "clValidatorsBalance", type: "uint256" },
      { indexed: false, name: "clPendingBalance", type: "uint256" },
    ],
    name: "CLBalancesUpdated",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "depositedPostReport", type: "uint256" }],
    name: "DepositedPostReportUpdated",
    type: "event",
  },
  {
    anonymous: false,
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: "depositsReserve", type: "uint256" }],
    name: "DepositsReserveSet",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: "depositsReserveTarget", type: "uint256" },
    ],
    name: "DepositsReserveTargetSet",
    type: "event",
  },
  {
    anonymous: false,
